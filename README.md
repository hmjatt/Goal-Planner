...
An implementation of **`Goal Planner`** in `ReactJS` with user authentication. A user can login and track their goals they have set. While creating this project I learned about `REST-API`, `Postman`, `Mongoose` `MongoDB`, `ExpressJS`, `ReactJS`, `NodeJS`, `Postman` etc. After creating the project, it was deployed to `AWS` :bird: Feel free to reach me on[Twitter](https://twitter.com/hmjatt/)
